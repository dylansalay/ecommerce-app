...
InventoryItem.create!(
  ...
  unit_cost: 12,
  images: [seed_image('the jasmine', 'jasmine2'), seed_image('the jasmine', 'jasmine3'), seed_image('the jasmine', 'jasmine4'), seed_image('the jasmine', 'jasmine5'), seed_image('the jasmine', 'jasmine6')], # rubocop:disable Layout/LineLength
...
InventoryItem.create!(
  ...
  unit_cost: 10,
  images: [seed_image('the poppy', 'poppy2'), seed_image('the poppy', 'poppy3'), seed_image('the poppy', 'poppy4'), seed_image('the poppy', 'poppy5'), seed_image('the poppy', 'poppy6'), seed_image('the poppy', 'poppy7'), seed_image('the poppy', 'poppy8')], # rubocop:disable Layout/LineLength
...
InventoryItem.create!(
  ...
  unit_cost: 10,
  images: [seed_image('the dahlia', 'dahlia2'), seed_image('the dahlia', 'dahlia3'), seed_image('the dahlia', 'dahlia4'), seed_image('the dahlia', 'dahlia5'), seed_image('the dahlia', 'dahlia6'), seed_image('the dahlia', 'dahlia7'), seed_image('the dahlia', 'dahlia8')], # rubocop:disable Layout/LineLength
...
InventoryItem.create!(
  ...
  unit_cost: 10,
  images: [seed_image('the daisy', 'daisy2'), seed_image('the daisy', 'daisy3'), seed_image('the daisy', 'daisy4'), seed_image('the daisy', 'daisy5'), seed_image('the daisy', 'daisy6'), seed_image('the daisy', 'daisy7'), seed_image('the daisy', 'daisy8'), seed_image('the daisy', 'daisy9'), seed_image('the daisy', 'daisy10')], # rubocop:disable Layout/LineLength
